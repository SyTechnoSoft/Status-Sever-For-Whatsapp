            ...
            videoView.setOnPreparedListener(mp -> {
                ...
                pausePlay.setOnClickListener(v -> {
                    if (videoView.isPlaying()) {
                        videoView.pause();
                        Glide.with(VideoPlayActivity.this).load(R.drawable.baseline_play_circle_24).into(pausePlay);
                    } else {
                        videoView.resume();
                        Glide.with(VideoPlayActivity.this).load(R.drawable.baseline_pause_circle_24).into(pausePlay);
                    }
                });
            });
        }
